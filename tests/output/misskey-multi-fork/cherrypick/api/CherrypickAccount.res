...
type postBlockingCreateResponse = CherrypickComponentSchemas.UserDetailedNotMe.t

let postBlockingCreateResponseSchema = CherrypickComponentSchemas.UserDetailedNotMe.schema
...
type postBlockingDeleteResponse = CherrypickComponentSchemas.UserDetailedNotMe.t

let postBlockingDeleteResponseSchema = CherrypickComponentSchemas.UserDetailedNotMe.schema
...
type postBlockingListResponse = array<CherrypickComponentSchemas.Blocking.t>

let postBlockingListResponseSchema = S.array(CherrypickComponentSchemas.Blocking.schema)
...
type postClipsNotesResponse = array<CherrypickComponentSchemas.Note.t>

let postClipsNotesResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postFlashMyResponse = array<CherrypickComponentSchemas.Flash.t>

let postFlashMyResponseSchema = S.array(CherrypickComponentSchemas.Flash.schema)
...
type postFlashMyLikesResponse = array<{
  id: string,
  flash: CherrypickComponentSchemas.Flash.t,
}>

let postFlashMyLikesResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    flash: s.field("flash", CherrypickComponentSchemas.Flash.schema),
  }))
...
type postIResponse = CherrypickComponentSchemas.MeDetailed.t

let postIResponseSchema = CherrypickComponentSchemas.MeDetailed.schema
...
type postIFavoritesResponse = array<CherrypickComponentSchemas.NoteFavorite.t>

let postIFavoritesResponseSchema = S.array(CherrypickComponentSchemas.NoteFavorite.schema)
...
type postIGalleryLikesResponse = array<{
  id: string,
  post: CherrypickComponentSchemas.GalleryPost.t,
}>

let postIGalleryLikesResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    post: s.field("post", CherrypickComponentSchemas.GalleryPost.schema),
  }))
...
type postIGalleryPostsResponse = array<CherrypickComponentSchemas.GalleryPost.t>

let postIGalleryPostsResponseSchema = S.array(CherrypickComponentSchemas.GalleryPost.schema)
...
type postINotificationsResponse = array<CherrypickComponentSchemas.Notification.t>

let postINotificationsResponseSchema = S.array(CherrypickComponentSchemas.Notification.schema)
...
type postINotificationsGroupedResponse = array<CherrypickComponentSchemas.Notification.t>

let postINotificationsGroupedResponseSchema = S.array(CherrypickComponentSchemas.Notification.schema)
...
type postIPageLikesResponse = array<{
  id: string,
  page: CherrypickComponentSchemas.Page.t,
}>

let postIPageLikesResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    page: s.field("page", CherrypickComponentSchemas.Page.schema),
  }))
...
type postIPagesResponse = array<CherrypickComponentSchemas.Page.t>

let postIPagesResponseSchema = S.array(CherrypickComponentSchemas.Page.schema)
...
type postIPinResponse = CherrypickComponentSchemas.MeDetailed.t

let postIPinResponseSchema = CherrypickComponentSchemas.MeDetailed.schema
...
type postIUnpinResponse = CherrypickComponentSchemas.MeDetailed.t

let postIUnpinResponseSchema = CherrypickComponentSchemas.MeDetailed.schema
...
type postIUpdateResponse = CherrypickComponentSchemas.MeDetailed.t

let postIUpdateResponseSchema = CherrypickComponentSchemas.MeDetailed.schema
...
type postIUserGroupInvitesResponse = array<{
  id: string,
  group: CherrypickComponentSchemas.UserGroup.t,
}>

let postIUserGroupInvitesResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    group: s.field("group", CherrypickComponentSchemas.UserGroup.schema),
  }))
...
type postMuteListResponse = array<CherrypickComponentSchemas.Muting.t>

let postMuteListResponseSchema = S.array(CherrypickComponentSchemas.Muting.schema)
...
type postRenoteMuteListResponse = array<CherrypickComponentSchemas.RenoteMuting.t>

let postRenoteMuteListResponseSchema = S.array(CherrypickComponentSchemas.RenoteMuting.schema)
