...
type postAdminAbuseReportNotificationRecipientCreateResponse = CherrypickComponentSchemas.AbuseReportNotificationRecipient.t

let postAdminAbuseReportNotificationRecipientCreateResponseSchema = CherrypickComponentSchemas.AbuseReportNotificationRecipient.schema
...
type postAdminAbuseReportNotificationRecipientShowResponse = CherrypickComponentSchemas.AbuseReportNotificationRecipient.t

let postAdminAbuseReportNotificationRecipientShowResponseSchema = CherrypickComponentSchemas.AbuseReportNotificationRecipient.schema
...
type postAdminAbuseReportNotificationRecipientUpdateResponse = CherrypickComponentSchemas.AbuseReportNotificationRecipient.t

let postAdminAbuseReportNotificationRecipientUpdateResponseSchema = CherrypickComponentSchemas.AbuseReportNotificationRecipient.schema
...
type postAdminAbuseUserReportsResponse = array<{
  ...
  targetUserId: string,
  assigneeId: JSON.t,
  reporter: CherrypickComponentSchemas.UserDetailedNotMe.t,
  targetUser: CherrypickComponentSchemas.UserDetailedNotMe.t,
  assignee: JSON.t,
  forwarded: bool,
  resolvedAs: JSON.t,
...
let postAdminAbuseUserReportsResponseSchema = S.array(S.object(s => {
    ...
    reporter: s.field("reporter", CherrypickComponentSchemas.UserDetailedNotMe.schema),
    targetUser: s.field("targetUser", CherrypickComponentSchemas.UserDetailedNotMe.schema),
    assignee: s.field("assignee", S.json),
...
type postAdminAccountsFindByEmailResponse = CherrypickComponentSchemas.UserDetailedNotMe.t

let postAdminAccountsFindByEmailResponseSchema = CherrypickComponentSchemas.UserDetailedNotMe.schema
...
type postAdminAdCreateResponse = CherrypickComponentSchemas.Ad.t

let postAdminAdCreateResponseSchema = CherrypickComponentSchemas.Ad.schema
...
type postAdminAdListResponse = array<CherrypickComponentSchemas.Ad.t>

let postAdminAdListResponseSchema = S.array(CherrypickComponentSchemas.Ad.schema)
...
type postAdminDriveFilesResponse = array<CherrypickComponentSchemas.DriveFile.t>

let postAdminDriveFilesResponseSchema = S.array(CherrypickComponentSchemas.DriveFile.schema)
...
type postAdminEmojiAddResponse = CherrypickComponentSchemas.EmojiDetailed.t

let postAdminEmojiAddResponseSchema = CherrypickComponentSchemas.EmojiDetailed.schema
...
type postAdminQueueJobsResponse = array<CherrypickComponentSchemas.QueueJob.t>

let postAdminQueueJobsResponseSchema = S.array(CherrypickComponentSchemas.QueueJob.schema)
...
type postAdminQueueQueueStatsResponse = {
  ...
  isPaused: bool,
  metrics: {
  completed: CherrypickComponentSchemas.QueueMetrics.t,
  failed: CherrypickComponentSchemas.QueueMetrics.t,
},
  db: {
  version: string,
  mode: string,
...
let postAdminQueueQueueStatsResponseSchema = S.object(s => {
    ...
    completed: s.field("completed", CherrypickComponentSchemas.QueueMetrics.schema),
    failed: s.field("failed", CherrypickComponentSchemas.QueueMetrics.schema),
  })),
...
type postAdminQueueShowJobResponse = CherrypickComponentSchemas.QueueJob.t

let postAdminQueueShowJobResponseSchema = CherrypickComponentSchemas.QueueJob.schema
...
type postAdminRolesCreateResponse = CherrypickComponentSchemas.Role.t

let postAdminRolesCreateResponseSchema = CherrypickComponentSchemas.Role.schema
...
type postAdminRolesShowResponse = CherrypickComponentSchemas.Role.t

let postAdminRolesShowResponseSchema = CherrypickComponentSchemas.Role.schema
...
type postAdminRolesUsersResponse = array<{
  id: string,
  createdAt: string,
  user: CherrypickComponentSchemas.UserDetailed.t,
  expiresAt: JSON.t,
}>
...
let postAdminRolesUsersResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    createdAt: s.field("createdAt", S.string),
    user: s.field("user", CherrypickComponentSchemas.UserDetailed.schema),
...
type postAdminShowModerationLogsResponse = array<{
  ...
  info: JSON.t,
  userId: string,
  user: CherrypickComponentSchemas.UserDetailedNotMe.t,
}>
...
let postAdminShowModerationLogsResponseSchema = S.array(S.object(s => {
    ...
    userId: s.field("userId", S.string),
    user: s.field("user", CherrypickComponentSchemas.UserDetailedNotMe.schema),
  }))
...
type postAdminShowUserResponse = {
  ...
  moderationNote: string,
  signins: array<CherrypickComponentSchemas.Signin.t>,
  policies: CherrypickComponentSchemas.RolePolicies.t,
  roles: array<CherrypickComponentSchemas.Role.t>,
  roleAssigns: array<{
  createdAt: string,
  expiresAt: JSON.t,
  roleId: string,
...
let postAdminShowUserResponseSchema = S.object(s => {
    ...
    moderationNote: s.field("moderationNote", S.string),
    signins: s.field("signins", S.array(CherrypickComponentSchemas.Signin.schema)),
    policies: s.field("policies", CherrypickComponentSchemas.RolePolicies.schema),
    roles: s.field("roles", S.array(CherrypickComponentSchemas.Role.schema)),
...
type postAdminSystemWebhookCreateResponse = CherrypickComponentSchemas.SystemWebhook.t

let postAdminSystemWebhookCreateResponseSchema = CherrypickComponentSchemas.SystemWebhook.schema
...
type postAdminSystemWebhookShowResponse = CherrypickComponentSchemas.SystemWebhook.t

let postAdminSystemWebhookShowResponseSchema = CherrypickComponentSchemas.SystemWebhook.schema
...
type postAdminSystemWebhookUpdateResponse = CherrypickComponentSchemas.SystemWebhook.t

let postAdminSystemWebhookUpdateResponseSchema = CherrypickComponentSchemas.SystemWebhook.schema
...
type postAdminUpdateProxyAccountResponse = CherrypickComponentSchemas.UserDetailed.t

let postAdminUpdateProxyAccountResponseSchema = CherrypickComponentSchemas.UserDetailed.schema
...
type postV2AdminEmojiListResponse = {
  emojis: array<CherrypickComponentSchemas.EmojiDetailedAdmin.t>,
  count: int,
  allCount: int,
  allPages: int,
}
...
let postV2AdminEmojiListResponseSchema = S.object(s => {
    emojis: s.field("emojis", S.array(CherrypickComponentSchemas.EmojiDetailedAdmin.schema)),
