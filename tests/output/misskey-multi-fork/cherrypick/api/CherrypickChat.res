...
type postChatHistoryResponse = array<CherrypickComponentSchemas.ChatMessage.t>

let postChatHistoryResponseSchema = S.array(CherrypickComponentSchemas.ChatMessage.schema)
...
type postChatMessagesCreateToRoomResponse = CherrypickComponentSchemas.ChatMessageLiteForRoom.t

let postChatMessagesCreateToRoomResponseSchema = CherrypickComponentSchemas.ChatMessageLiteForRoom.schema
...
type postChatMessagesCreateToUserResponse = CherrypickComponentSchemas.ChatMessageLiteFor1On1.t

let postChatMessagesCreateToUserResponseSchema = CherrypickComponentSchemas.ChatMessageLiteFor1On1.schema
...
type postChatMessagesRoomTimelineResponse = array<CherrypickComponentSchemas.ChatMessageLiteForRoom.t>

let postChatMessagesRoomTimelineResponseSchema = S.array(CherrypickComponentSchemas.ChatMessageLiteForRoom.schema)
...
type postChatMessagesSearchResponse = array<CherrypickComponentSchemas.ChatMessage.t>

let postChatMessagesSearchResponseSchema = S.array(CherrypickComponentSchemas.ChatMessage.schema)
...
type postChatMessagesShowResponse = CherrypickComponentSchemas.ChatMessage.t

let postChatMessagesShowResponseSchema = CherrypickComponentSchemas.ChatMessage.schema
...
type postChatMessagesUserTimelineResponse = array<CherrypickComponentSchemas.ChatMessageLiteFor1On1.t>

let postChatMessagesUserTimelineResponseSchema = S.array(CherrypickComponentSchemas.ChatMessageLiteFor1On1.schema)
...
type postChatRoomsCreateResponse = CherrypickComponentSchemas.ChatRoom.t

let postChatRoomsCreateResponseSchema = CherrypickComponentSchemas.ChatRoom.schema
...
type postChatRoomsInvitationsCreateResponse = CherrypickComponentSchemas.ChatRoomInvitation.t

let postChatRoomsInvitationsCreateResponseSchema = CherrypickComponentSchemas.ChatRoomInvitation.schema
...
type postChatRoomsInvitationsInboxResponse = array<CherrypickComponentSchemas.ChatRoomInvitation.t>

let postChatRoomsInvitationsInboxResponseSchema = S.array(CherrypickComponentSchemas.ChatRoomInvitation.schema)
...
type postChatRoomsInvitationsOutboxResponse = array<CherrypickComponentSchemas.ChatRoomInvitation.t>

let postChatRoomsInvitationsOutboxResponseSchema = S.array(CherrypickComponentSchemas.ChatRoomInvitation.schema)
...
type postChatRoomsJoiningResponse = array<CherrypickComponentSchemas.ChatRoomMembership.t>

let postChatRoomsJoiningResponseSchema = S.array(CherrypickComponentSchemas.ChatRoomMembership.schema)
...
type postChatRoomsMembersResponse = array<CherrypickComponentSchemas.ChatRoomMembership.t>

let postChatRoomsMembersResponseSchema = S.array(CherrypickComponentSchemas.ChatRoomMembership.schema)
...
type postChatRoomsOwnedResponse = array<CherrypickComponentSchemas.ChatRoom.t>

let postChatRoomsOwnedResponseSchema = S.array(CherrypickComponentSchemas.ChatRoom.schema)
...
type postChatRoomsShowResponse = CherrypickComponentSchemas.ChatRoom.t

let postChatRoomsShowResponseSchema = CherrypickComponentSchemas.ChatRoom.schema
...
type postChatRoomsUpdateResponse = CherrypickComponentSchemas.ChatRoom.t

let postChatRoomsUpdateResponseSchema = CherrypickComponentSchemas.ChatRoom.schema
