...
type postUsersListsCreateResponse = CherrypickComponentSchemas.UserList.t

let postUsersListsCreateResponseSchema = CherrypickComponentSchemas.UserList.schema
...
type postUsersListsGetMembershipsResponse = array<{
  ...
  createdAt: string,
  userId: string,
  user: CherrypickComponentSchemas.UserLite.t,
  withReplies: bool,
}>
...
let postUsersListsGetMembershipsResponseSchema = S.array(S.object(s => {
    ...
    user: s.field("user", CherrypickComponentSchemas.UserLite.schema),
...
type postUsersListsUpdateResponse = CherrypickComponentSchemas.UserList.t

let postUsersListsUpdateResponseSchema = CherrypickComponentSchemas.UserList.schema
