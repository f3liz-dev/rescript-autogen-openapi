...
type postChannelsTimelineResponse = array<CherrypickComponentSchemas.Note.t>

let postChannelsTimelineResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesBubbleTimelineResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesBubbleTimelineResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesChildrenResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesChildrenResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesCreateResponse = {
  createdNote: CherrypickComponentSchemas.Note.t,
}

let postNotesCreateResponseSchema = S.object(s => {
    createdNote: s.field("createdNote", CherrypickComponentSchemas.Note.schema),
  })
...
type postNotesDraftsCreateResponse = {
  createdDraft: CherrypickComponentSchemas.NoteDraft.t,
}

let postNotesDraftsCreateResponseSchema = S.object(s => {
    createdDraft: s.field("createdDraft", CherrypickComponentSchemas.NoteDraft.schema),
  })
...
type postNotesDraftsListResponse = array<CherrypickComponentSchemas.NoteDraft.t>

let postNotesDraftsListResponseSchema = S.array(CherrypickComponentSchemas.NoteDraft.schema)
...
type postNotesDraftsUpdateResponse = {
  updatedDraft: CherrypickComponentSchemas.NoteDraft.t,
}

let postNotesDraftsUpdateResponseSchema = S.object(s => {
    updatedDraft: s.field("updatedDraft", CherrypickComponentSchemas.NoteDraft.schema),
  })
...
type postNotesEventsSearchResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesEventsSearchResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesGlobalTimelineResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesGlobalTimelineResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesHistoryResponse = array<CherrypickComponentSchemas.NoteHistory.t>

let postNotesHistoryResponseSchema = S.array(CherrypickComponentSchemas.NoteHistory.schema)
...
type postNotesHybridTimelineResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesHybridTimelineResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesLocalTimelineResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesLocalTimelineResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesMentionsResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesMentionsResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type getNotesReactionsResponse = array<CherrypickComponentSchemas.NoteReaction.t>

let getNotesReactionsResponseSchema = S.array(CherrypickComponentSchemas.NoteReaction.schema)
...
type postNotesReactionsResponse = array<CherrypickComponentSchemas.NoteReaction.t>

let postNotesReactionsResponseSchema = S.array(CherrypickComponentSchemas.NoteReaction.schema)
...
type postNotesRenotesResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesRenotesResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesRepliesResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesRepliesResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesSearchResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesSearchResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesSearchByTagResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesSearchByTagResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesShowResponse = CherrypickComponentSchemas.Note.t

let postNotesShowResponseSchema = CherrypickComponentSchemas.Note.schema
...
type postNotesTimelineResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesTimelineResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
...
type postNotesUserListTimelineResponse = array<CherrypickComponentSchemas.Note.t>

let postNotesUserListTimelineResponseSchema = S.array(CherrypickComponentSchemas.Note.schema)
