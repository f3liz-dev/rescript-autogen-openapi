...
type postBlockingCreateResponse = MisskeyComponentSchemas.UserDetailedNotMe.t

let postBlockingCreateResponseSchema = MisskeyComponentSchemas.UserDetailedNotMe.schema
...
type postBlockingDeleteResponse = MisskeyComponentSchemas.UserDetailedNotMe.t

let postBlockingDeleteResponseSchema = MisskeyComponentSchemas.UserDetailedNotMe.schema
...
type postBlockingListResponse = array<MisskeyComponentSchemas.Blocking.t>

let postBlockingListResponseSchema = S.array(MisskeyComponentSchemas.Blocking.schema)
...
type postClipsMyFavoritesResponse = array<MisskeyComponentSchemas.Clip.t>

let postClipsMyFavoritesResponseSchema = S.array(MisskeyComponentSchemas.Clip.schema)
...
type postClipsNotesResponse = array<MisskeyComponentSchemas.Note.t>

let postClipsNotesResponseSchema = S.array(MisskeyComponentSchemas.Note.schema)
...
type postFlashMyResponse = array<MisskeyComponentSchemas.Flash.t>

let postFlashMyResponseSchema = S.array(MisskeyComponentSchemas.Flash.schema)
...
type postFlashMyLikesResponse = array<{
  id: string,
  flash: MisskeyComponentSchemas.Flash.t,
}>

let postFlashMyLikesResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    flash: s.field("flash", MisskeyComponentSchemas.Flash.schema),
  }))
...
type postIResponse = MisskeyComponentSchemas.MeDetailed.t

let postIResponseSchema = MisskeyComponentSchemas.MeDetailed.schema
...
type postIFavoritesResponse = array<MisskeyComponentSchemas.NoteFavorite.t>

let postIFavoritesResponseSchema = S.array(MisskeyComponentSchemas.NoteFavorite.schema)
...
type postIGalleryLikesResponse = array<{
  id: string,
  post: MisskeyComponentSchemas.GalleryPost.t,
}>

let postIGalleryLikesResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    post: s.field("post", MisskeyComponentSchemas.GalleryPost.schema),
  }))
...
type postIGalleryPostsResponse = array<MisskeyComponentSchemas.GalleryPost.t>

let postIGalleryPostsResponseSchema = S.array(MisskeyComponentSchemas.GalleryPost.schema)
...
type postINotificationsResponse = array<MisskeyComponentSchemas.Notification.t>

let postINotificationsResponseSchema = S.array(MisskeyComponentSchemas.Notification.schema)
...
type postINotificationsGroupedResponse = array<MisskeyComponentSchemas.Notification.t>

let postINotificationsGroupedResponseSchema = S.array(MisskeyComponentSchemas.Notification.schema)
...
type postIPageLikesResponse = array<{
  id: string,
  page: MisskeyComponentSchemas.Page.t,
}>

let postIPageLikesResponseSchema = S.array(S.object(s => {
    id: s.field("id", S.string),
    page: s.field("page", MisskeyComponentSchemas.Page.schema),
  }))
...
type postIPagesResponse = array<MisskeyComponentSchemas.Page.t>

let postIPagesResponseSchema = S.array(MisskeyComponentSchemas.Page.schema)
...
type postIPinResponse = MisskeyComponentSchemas.MeDetailed.t

let postIPinResponseSchema = MisskeyComponentSchemas.MeDetailed.schema
...
type postIUnpinResponse = MisskeyComponentSchemas.MeDetailed.t

let postIUnpinResponseSchema = MisskeyComponentSchemas.MeDetailed.schema
...
type postIUpdateResponse = MisskeyComponentSchemas.MeDetailed.t

let postIUpdateResponseSchema = MisskeyComponentSchemas.MeDetailed.schema
...
type postMuteListResponse = array<MisskeyComponentSchemas.Muting.t>

let postMuteListResponseSchema = S.array(MisskeyComponentSchemas.Muting.schema)
...
type postMyAppsResponse = array<MisskeyComponentSchemas.App.t>

let postMyAppsResponseSchema = S.array(MisskeyComponentSchemas.App.schema)
...
type postRenoteMuteListResponse = array<MisskeyComponentSchemas.RenoteMuting.t>

let postRenoteMuteListResponseSchema = S.array(MisskeyComponentSchemas.RenoteMuting.schema)
