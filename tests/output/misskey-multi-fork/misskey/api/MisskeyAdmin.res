...
type postAdminAbuseReportNotificationRecipientCreateResponse = MisskeyComponentSchemas.AbuseReportNotificationRecipient.t

let postAdminAbuseReportNotificationRecipientCreateResponseSchema = MisskeyComponentSchemas.AbuseReportNotificationRecipient.schema
...
type postAdminAbuseReportNotificationRecipientListResponse = array<MisskeyComponentSchemas.AbuseReportNotificationRecipient.t>

let postAdminAbuseReportNotificationRecipientListResponseSchema = S.array(MisskeyComponentSchemas.AbuseReportNotificationRecipient.schema)
...
type postAdminAbuseReportNotificationRecipientShowResponse = MisskeyComponentSchemas.AbuseReportNotificationRecipient.t

let postAdminAbuseReportNotificationRecipientShowResponseSchema = MisskeyComponentSchemas.AbuseReportNotificationRecipient.schema
...
type postAdminAbuseReportNotificationRecipientUpdateResponse = MisskeyComponentSchemas.AbuseReportNotificationRecipient.t

let postAdminAbuseReportNotificationRecipientUpdateResponseSchema = MisskeyComponentSchemas.AbuseReportNotificationRecipient.schema
...
type postAdminAbuseUserReportsResponse = array<{
  ...
  targetUserId: string,
  assigneeId: JSON.t,
  reporter: MisskeyComponentSchemas.UserDetailed.t,
  targetUser: MisskeyComponentSchemas.UserDetailed.t,
...
let postAdminAbuseUserReportsResponseSchema = S.array(S.object(s => {
    ...
    reporter: s.field("reporter", MisskeyComponentSchemas.UserDetailed.schema),
    targetUser: s.field("targetUser", MisskeyComponentSchemas.UserDetailed.schema),
...
type postAdminAccountsCreateResponse = MisskeyComponentSchemas.MeDetailed.t

let postAdminAccountsCreateResponseSchema = MisskeyComponentSchemas.MeDetailed.schema
...
type postAdminAccountsFindByEmailResponse = MisskeyComponentSchemas.UserDetailed.t

let postAdminAccountsFindByEmailResponseSchema = MisskeyComponentSchemas.UserDetailed.schema
...
type postAdminAdCreateResponse = MisskeyComponentSchemas.Ad.t

let postAdminAdCreateResponseSchema = MisskeyComponentSchemas.Ad.schema
...
type postAdminAdListResponse = array<MisskeyComponentSchemas.Ad.t>

let postAdminAdListResponseSchema = S.array(MisskeyComponentSchemas.Ad.schema)
...
type postAdminDriveFilesResponse = array<MisskeyComponentSchemas.DriveFile.t>

let postAdminDriveFilesResponseSchema = S.array(MisskeyComponentSchemas.DriveFile.schema)
...
type postAdminEmojiAddResponse = MisskeyComponentSchemas.EmojiDetailed.t

let postAdminEmojiAddResponseSchema = MisskeyComponentSchemas.EmojiDetailed.schema
...
type postAdminInviteCreateResponse = array<MisskeyComponentSchemas.InviteCode.t>

let postAdminInviteCreateResponseSchema = S.array(MisskeyComponentSchemas.InviteCode.schema)
...
type postAdminInviteListResponse = array<MisskeyComponentSchemas.InviteCode.t>

let postAdminInviteListResponseSchema = S.array(MisskeyComponentSchemas.InviteCode.schema)
...
type postAdminQueueStatsResponse = {
  deliver: MisskeyComponentSchemas.QueueCount.t,
  inbox: MisskeyComponentSchemas.QueueCount.t,
  db: MisskeyComponentSchemas.QueueCount.t,
  objectStorage: MisskeyComponentSchemas.QueueCount.t,
}

let postAdminQueueStatsResponseSchema = S.object(s => {
    deliver: s.field("deliver", MisskeyComponentSchemas.QueueCount.schema),
    inbox: s.field("inbox", MisskeyComponentSchemas.QueueCount.schema),
    db: s.field("db", MisskeyComponentSchemas.QueueCount.schema),
    objectStorage: s.field("objectStorage", MisskeyComponentSchemas.QueueCount.schema),
  })
...
type postAdminRolesCreateResponse = MisskeyComponentSchemas.Role.t

let postAdminRolesCreateResponseSchema = MisskeyComponentSchemas.Role.schema
...
type postAdminRolesListResponse = array<MisskeyComponentSchemas.Role.t>

let postAdminRolesListResponseSchema = S.array(MisskeyComponentSchemas.Role.schema)
...
type postAdminRolesShowResponse = MisskeyComponentSchemas.Role.t

let postAdminRolesShowResponseSchema = MisskeyComponentSchemas.Role.schema
...
let postAdminRolesUpdateInlinePoliciesRequestSchema = S.object(s => {
    ...
    value: s.fieldOr("value", S.nullableAsOption(S.json), None),
    memo: s.fieldOr("memo", S.nullableAsOption(S.json), None),
  }))),
  })
...
type postAdminShowUserResponse = {
  ...
  signins: array<MisskeyComponentSchemas.Signin.t>,
  policies: MisskeyComponentSchemas.RolePolicies.t,
  roles: array<MisskeyComponentSchemas.Role.t>,
  roleAssigns: array<{
  createdAt: string,
  expiresAt: JSON.t,
  roleId: string,
...
let postAdminShowUserResponseSchema = S.object(s => {
    ...
    signins: s.field("signins", S.array(MisskeyComponentSchemas.Signin.schema)),
    policies: s.field("policies", MisskeyComponentSchemas.RolePolicies.schema),
    roles: s.field("roles", S.array(MisskeyComponentSchemas.Role.schema)),
...
type postAdminShowUserAccountMoveLogsResponse = array<{
  ...
  createdAt: string,
  movedToId: string,
  movedTo: MisskeyComponentSchemas.UserDetailed.t,
  movedFromId: string,
  movedFrom: MisskeyComponentSchemas.UserDetailed.t,
}>
...
let postAdminShowUserAccountMoveLogsResponseSchema = S.array(S.object(s => {
    ...
    movedTo: s.field("movedTo", MisskeyComponentSchemas.UserDetailed.schema),
    movedFromId: s.field("movedFromId", S.string),
    movedFrom: s.field("movedFrom", MisskeyComponentSchemas.UserDetailed.schema),
  }))
...
type postAdminShowUsersResponse = array<MisskeyComponentSchemas.UserDetailed.t>

let postAdminShowUsersResponseSchema = S.array(MisskeyComponentSchemas.UserDetailed.schema)
...
type postAdminSystemWebhookCreateResponse = MisskeyComponentSchemas.SystemWebhook.t

let postAdminSystemWebhookCreateResponseSchema = MisskeyComponentSchemas.SystemWebhook.schema
...
type postAdminSystemWebhookListResponse = array<MisskeyComponentSchemas.SystemWebhook.t>

let postAdminSystemWebhookListResponseSchema = S.array(MisskeyComponentSchemas.SystemWebhook.schema)
...
type postAdminSystemWebhookShowResponse = MisskeyComponentSchemas.SystemWebhook.t

let postAdminSystemWebhookShowResponseSchema = MisskeyComponentSchemas.SystemWebhook.schema
...
type postAdminSystemWebhookUpdateResponse = MisskeyComponentSchemas.SystemWebhook.t

let postAdminSystemWebhookUpdateResponseSchema = MisskeyComponentSchemas.SystemWebhook.schema
...
type postAdminUpdateProxyAccountResponse = MisskeyComponentSchemas.UserDetailed.t

let postAdminUpdateProxyAccountResponseSchema = MisskeyComponentSchemas.UserDetailed.schema
...
type postV2AdminEmojiListResponse = {
  emojis: array<MisskeyComponentSchemas.EmojiDetailedAdmin.t>,
  count: int,
  allCount: int,
  allPages: int,
}
...
let postV2AdminEmojiListResponseSchema = S.object(s => {
    emojis: s.field("emojis", S.array(MisskeyComponentSchemas.EmojiDetailedAdmin.schema)),
