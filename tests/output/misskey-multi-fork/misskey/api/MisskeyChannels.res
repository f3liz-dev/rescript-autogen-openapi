...
type postChannelsCreateResponse = MisskeyComponentSchemas.Channel.t

let postChannelsCreateResponseSchema = MisskeyComponentSchemas.Channel.schema
...
type postChannelsFeaturedResponse = array<MisskeyComponentSchemas.Channel.t>

let postChannelsFeaturedResponseSchema = S.array(MisskeyComponentSchemas.Channel.schema)
...
type postChannelsFeaturedGamesResponse = array<MisskeyComponentSchemas.Channel.t>

let postChannelsFeaturedGamesResponseSchema = S.array(MisskeyComponentSchemas.Channel.schema)
...
type postChannelsFollowedResponse = array<MisskeyComponentSchemas.Channel.t>

let postChannelsFollowedResponseSchema = S.array(MisskeyComponentSchemas.Channel.schema)
...
type postChannelsMyFavoritesResponse = array<MisskeyComponentSchemas.Channel.t>

let postChannelsMyFavoritesResponseSchema = S.array(MisskeyComponentSchemas.Channel.schema)
...
type postChannelsOwnedResponse = array<MisskeyComponentSchemas.Channel.t>

let postChannelsOwnedResponseSchema = S.array(MisskeyComponentSchemas.Channel.schema)
...
type postChannelsSearchResponse = array<MisskeyComponentSchemas.Channel.t>

let postChannelsSearchResponseSchema = S.array(MisskeyComponentSchemas.Channel.schema)
...
type postChannelsShowResponse = MisskeyComponentSchemas.Channel.t

let postChannelsShowResponseSchema = MisskeyComponentSchemas.Channel.schema
...
type postChannelsUpdateResponse = MisskeyComponentSchemas.Channel.t

let postChannelsUpdateResponseSchema = MisskeyComponentSchemas.Channel.schema
