...
type postFederationFollowersResponse = array<MisskeyComponentSchemas.Following.t>

let postFederationFollowersResponseSchema = S.array(MisskeyComponentSchemas.Following.schema)
...
type postFederationFollowingResponse = array<MisskeyComponentSchemas.Following.t>

let postFederationFollowingResponseSchema = S.array(MisskeyComponentSchemas.Following.schema)
...
type getFederationInstancesResponse = array<MisskeyComponentSchemas.FederationInstance.t>

let getFederationInstancesResponseSchema = S.array(MisskeyComponentSchemas.FederationInstance.schema)
...
type postFederationInstancesResponse = array<MisskeyComponentSchemas.FederationInstance.t>

let postFederationInstancesResponseSchema = S.array(MisskeyComponentSchemas.FederationInstance.schema)
...
type getFederationStatsResponse = {
  topSubInstances: array<MisskeyComponentSchemas.FederationInstance.t>,
  otherFollowersCount: float,
  topPubInstances: array<MisskeyComponentSchemas.FederationInstance.t>,
  otherFollowingCount: float,
}

let getFederationStatsResponseSchema = S.object(s => {
    topSubInstances: s.field("topSubInstances", S.array(MisskeyComponentSchemas.FederationInstance.schema)),
    otherFollowersCount: s.field("otherFollowersCount", S.float),
    topPubInstances: s.field("topPubInstances", S.array(MisskeyComponentSchemas.FederationInstance.schema)),
...
type postFederationUsersResponse = array<MisskeyComponentSchemas.UserDetailedNotMe.t>

let postFederationUsersResponseSchema = S.array(MisskeyComponentSchemas.UserDetailedNotMe.schema)
