...
type postAnnouncementResponse = MisskeyComponentSchemas.Announcement.t

let postAnnouncementResponseSchema = MisskeyComponentSchemas.Announcement.schema
...
type postAnnouncementsResponse = array<MisskeyComponentSchemas.Announcement.t>

let postAnnouncementsResponseSchema = S.array(MisskeyComponentSchemas.Announcement.schema)
...
type postAnnouncementsShowResponse = MisskeyComponentSchemas.Announcement.t

let postAnnouncementsShowResponseSchema = MisskeyComponentSchemas.Announcement.schema
...
type getEmojiResponse = MisskeyComponentSchemas.EmojiDetailed.t

let getEmojiResponseSchema = MisskeyComponentSchemas.EmojiDetailed.schema
...
type postEmojiResponse = MisskeyComponentSchemas.EmojiDetailed.t

let postEmojiResponseSchema = MisskeyComponentSchemas.EmojiDetailed.schema
...
type getEmojisResponse = {
  emojis: array<MisskeyComponentSchemas.EmojiSimple.t>,
}

let getEmojisResponseSchema = S.object(s => {
    emojis: s.field("emojis", S.array(MisskeyComponentSchemas.EmojiSimple.schema)),
  })
...
type postInviteCreateResponse = MisskeyComponentSchemas.InviteCode.t

let postInviteCreateResponseSchema = MisskeyComponentSchemas.InviteCode.schema
...
type postInviteListResponse = array<MisskeyComponentSchemas.InviteCode.t>

let postInviteListResponseSchema = S.array(MisskeyComponentSchemas.InviteCode.schema)
