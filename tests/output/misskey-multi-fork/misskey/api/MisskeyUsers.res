...
type postPinnedUsersResponse = array<MisskeyComponentSchemas.UserDetailed.t>

let postPinnedUsersResponseSchema = S.array(MisskeyComponentSchemas.UserDetailed.schema)
...
type postUsersResponse = array<MisskeyComponentSchemas.UserDetailed.t>

let postUsersResponseSchema = S.array(MisskeyComponentSchemas.UserDetailed.schema)
...
type postUsersClipsResponse = array<MisskeyComponentSchemas.Clip.t>

let postUsersClipsResponseSchema = S.array(MisskeyComponentSchemas.Clip.schema)
...
type postUsersFlashsResponse = array<MisskeyComponentSchemas.Flash.t>

let postUsersFlashsResponseSchema = S.array(MisskeyComponentSchemas.Flash.schema)
...
type postUsersFollowersResponse = array<MisskeyComponentSchemas.Following.t>

let postUsersFollowersResponseSchema = S.array(MisskeyComponentSchemas.Following.schema)
...
type postUsersFollowingResponse = array<MisskeyComponentSchemas.Following.t>

let postUsersFollowingResponseSchema = S.array(MisskeyComponentSchemas.Following.schema)
...
type postUsersGalleryPostsResponse = array<MisskeyComponentSchemas.GalleryPost.t>

let postUsersGalleryPostsResponseSchema = S.array(MisskeyComponentSchemas.GalleryPost.schema)
...
type postUsersNotesResponse = array<MisskeyComponentSchemas.Note.t>

let postUsersNotesResponseSchema = S.array(MisskeyComponentSchemas.Note.schema)
...
type postUsersPagesResponse = array<MisskeyComponentSchemas.Page.t>

let postUsersPagesResponseSchema = S.array(MisskeyComponentSchemas.Page.schema)
...
type postUsersReactionsResponse = array<MisskeyComponentSchemas.NoteReaction.t>

let postUsersReactionsResponseSchema = S.array(MisskeyComponentSchemas.NoteReaction.schema)
...
type postUsersRecommendationResponse = array<MisskeyComponentSchemas.UserDetailed.t>

let postUsersRecommendationResponseSchema = S.array(MisskeyComponentSchemas.UserDetailed.schema)
...
type postUsersSearchResponse = array<MisskeyComponentSchemas.User.t>

let postUsersSearchResponseSchema = S.array(MisskeyComponentSchemas.User.schema)
...
type postUsersSearchByUsernameAndHostResponse = array<MisskeyComponentSchemas.User.t>

let postUsersSearchByUsernameAndHostResponseSchema = S.array(MisskeyComponentSchemas.User.schema)
...
type postUsersShowResponse = array<MisskeyComponentSchemas.UserDetailed.t>

let postUsersShowResponseSchema = S.array(MisskeyComponentSchemas.UserDetailed.schema)
